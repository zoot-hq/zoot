  ...
  renderReactions() {
    return(
      <View style={{display: 'flex', flexDirection: 'row' }}>
        <TouchableOpacity style={{marginRight: 13}} onPress={() => this.react('likes')}><Foundation name='like' size={20}><Text> {this.state.likes.count || null}</Text></Foundation></TouchableOpacity>
