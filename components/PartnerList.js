  ...
  async componentDidMount() {
    ...
    async contactAdmin() {
      const options = {
        ...
        subject: 'Becoming a Partnered Organization',
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchView}>
        ...
        <TouchableOpacity style={style.subtitle} onPress={() => this.contactAdmin()}> Interested in partnering with Après? Click here to send us an email! Let’s chat. </TouchableOpacity>
      </View>
